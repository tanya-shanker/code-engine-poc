...
import (
	...
	"github.com/tanya-shanker/code-engine-poc/workspace-create/workspace"
)
...
func main() {
	...
	workspaceResponseList, err := workspace.CreateWorkspace("https://schematics.cloud.ibm.com/v1/workspaces", iam_token)
	if err != nil {
